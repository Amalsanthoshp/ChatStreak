# Generated by Django 2.2.7 on 2019-11-20 10:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivered_time', models.DateTimeField(verbose_name='Delivered at')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ManyToManyField(related_name='Message', to='frontend.Chat')),
